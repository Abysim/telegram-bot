 ...
 *
 * Changed to be able to run from cron.
 */
 ...
 * );
 */
class CustomcleanupCommand extends AdminCommand
{
    /**
     * @var string
     */
    protected $name = 'customcleanup';
     ...
     * @var string
     */
    protected $usage = '/customcleanup [dry] <days> or /customcleanup [dry] <count> <unit> (e.g. 3 weeks)';
    ...
    public function execute(): ServerResponse
    {
        ...
        $data = [
            'chat_id'    => $this->telegram->getAdminList()[0],
            'parse_mode' => 'Markdown',
        ];
